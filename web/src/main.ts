...
try {
  const elements: GameElements = {
    ...
    pause: requiredElement<HTMLButtonElement>("pause"),
    resume: requiredElement<HTMLButtonElement>("resume"),
    attack: requiredElement<HTMLButtonElement>("attack"),
    block: requiredElement<HTMLButtonElement>("block"),
    dodge: requiredElement<HTMLButtonElement>("dodge"),
    ...
    defeatOverlay: requiredElement("defeat-overlay"),
    healthFill: requiredElement("health-fill"),
    staminaFill: requiredElement("stamina-fill"),
    healthValue: requiredElement<HTMLOutputElement>("health-value"),
    staminaValue: requiredElement<HTMLOutputElement>("stamina-value"),
    enemyWidget: requiredElement("enemy-widget"),
    enemyHealthFill: requiredElement("enemy-health-fill"),
    combatFeedback: requiredElement<HTMLOutputElement>("combat-feedback"),
  };

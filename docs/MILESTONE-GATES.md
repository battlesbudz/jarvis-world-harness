...
- `2` — the gate could not be evaluated safely because its configuration or infrastructure is invalid.
...
- a fake-Codex lifecycle test proving exact thread persistence/resume and parseable JSONL/last-run metadata.
